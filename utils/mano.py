...
class MANO(object):
    def __init__(self):
        ...
        self.layer = {'right': smplx.create("./smplx_models", 'mano', is_rhand=True, use_pca=False, flat_hand_mean=False, **self.layer_arg),
                      'left': smplx.create("./smplx_models", 'mano', is_rhand=False, use_pca=False, flat_hand_mean=False, **self.layer_arg)}
        self.vertex_num = 778
